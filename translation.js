const translations = {
    de: {
        ...
        aboutP1: "<strong>PaceLeague Solutions GmbH</strong><br>Gegründet 2026, Wien<br>Fenerbahce Straße 1907, 1010 Wien<br>contact@paceleague.at<br>Wir entwickeln mobile Fitness-Software.",
        aboutP1b: "Die Idee zu PaceLeague kam eigentlich aus einem echten Problem: Wir selbst haben gemerkt, dass normales Schrittzählen einfach langweilig wird nach ein paar Wochen. Was fehlt ist ein Grund weiterzumachen, also haben wir einen gebaut. Klingt simpel, war es aber nicht.",
        aboutH2: "Unser Team",
        aboutP2: "Wir sind zu sechst, alle irgendwie zu viel am Handy:",
        ...
        bizP1: "Das Modell ist simpel: die App kostet nichts. Wer mehr will kann <strong>PaceLeague+</strong> holen, das sind 2,99 Euro im Monat oder 24,99 im Jahr. Kein Abo-Trick, kein automatisches Verlängern ohne Erinnerung.",
        ...
        brandNote: "Wir haben in den EUIPO und TMview Datenbanken nachgeschaut ob der Name oder die Marken schon vergeben sind. Stand Mai 2026 gab es keine Konflikte.",

        cookieText: "Diese Website verwendet Cookies zu Analysezwecken.",
        cookieBtn: "Akzeptieren",
        skipLink: "Zum Inhalt springen",
        linkAcc: "Barrierefreiheit", linkPriv: "Datenschutz", linkImp: "Impressum", linkCont: "Kontakt", linkLic: "Lizenz",
        btnDown: "Download App",
        dist19: "Bezirk 19"
    },
    en: {
        ...
        aboutH1: "The Company",
        aboutP1: "<strong>PaceLeague Solutions GmbH</strong><br>Founded 2026, Vienna<br>Fenerbahce Straße 1907, 1010 Vienna<br>contact@paceleague.at<br>We build mobile fitness software.",
        aboutP1b: "The idea for PaceLeague came from a real problem: we noticed that basic step counting gets boring after a few weeks. What's missing is a reason to keep going, so we built one. Sounds simple, but it wasn't.",
        aboutH2: "Our Team",
        aboutP2: "There are six of us, all probably on our phones too much:",
        ...
        bizP1: "Simple model: the app is free. If you want more, <strong>PaceLeague+</strong> is 2.99 Euro a month or 24.99 a year. No tricks, no automatic renewals without a reminder.",
        ...
        brandNote: "We checked the EUIPO and TMview databases to see if the name or marks were already taken. As of May 2026, no conflicts found.",

        cookieText: "This website uses cookies for analytical purposes.",
        cookieBtn: "Accept",
        skipLink: "Skip to content",
        linkAcc: "Accessibility", linkPriv: "Privacy Policy", linkImp: "Imprint", linkCont: "Contact", linkLic: "License",
        btnDown: "Download App",
        dist19: "District 19"
    }
};
...
function setLanguage(lang) {
    ...
    setText('cookie-text', t.cookieText);
    setText('cookie-btn', t.cookieBtn);
    setText('link-acc', t.linkAcc);
    setText('link-priv', t.linkPriv);
    setText('link-imp', t.linkImp);
    setText('link-cont', t.linkCont);
    setText('link-lic', t.linkLic);

    setText('hero-title', t.heroT);
    setText('hero-desc', t.heroD);
    setText('title-live', t.liveT);
    setText('label-steps', t.stepsL);
    setText('title-performer', t.performerT);
    setText('label-individual', t.indivL);
    setHtml('comm-card', t.commC);
    setText('dist-19', t.dist19);

    setText('title-features', t.featT);
    ...
    setText('about-p1b', t.aboutP1b);
    setText('about-h2', t.aboutH2);
    setText('about-p2', t.aboutP2);
    setText('job1', t.job1); setText('job2', t.job2); setText('job3', t.job3);
    setText('job4', t.job4); setText('job5', t.job5); setText('job6', t.job6);
    setText('about-h3', t.aboutH3);
    setText('about-p3', t.aboutP3);
    setHtml('prod-l1', t.prodL1); setHtml('prod-l2', t.prodL2); setHtml('prod-l3', t.prodL3);
    setHtml('prod-l4', t.prodL4); setHtml('prod-l5', t.prodL5); setHtml('prod-l6', t.prodL6);
    setText('about-h4', t.aboutH4);
    setText('about-p4', t.aboutP4);
    setText('about-h5', t.aboutH5);
    setHtml('biz-p1', t.bizP1);
    setText('biz-p2', t.bizP2);
    setText('biz-p3', t.bizP3);
    setText('about-h6', t.aboutH6);
    setHtml('brand-l1', t.brandL1); setHtml('brand-l2', t.brandL2); setHtml('brand-l3', t.brandL3);
    setText('brand-t1', t.brandT1); setText('brand-t2', t.brandT2); setText('brand-t3', t.brandT3);
    setText('brand-note', t.brandNote);
}
